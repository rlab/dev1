...
<?php include_once('_inc/header.php'); ?>
		...
		<header class="home">
			...
			<div class="header_graphic" style="background-image:url('img/header_backgrounds/cardinal-bg.jpg');">
        ...
        <div id="prospective_students" class="special_focus">
        	...
        	<header class="expandable">
        		...
        		<div class="wrap">
        			...
        			<img class="p-students_m" src="img/p-students_m.png" alt="" />

<?php
	$pagename = 'academics'; //all lowercase, no spaces. Used for class assignments
	$pagetitle = 'Academics'; //Used for the page's Title attribute
...
<?php include_once('_inc/header.php'); ?>
		...
		<header class="interior">
				...
				<div class="wrap">
					...
					<nav class="ninecol">
						...
						<ul>
							...
							<li class="browse"><a href="#">Browse A-Z</a></li>
			...
			<div class="photobar">
				...
				<ul class="photobar_photos">
					<li><img src="img/photobar/01.jpg" alt="" /></li>
					<li><img src="img/photobar/02.jpg" alt="" /></li>
					<img class="photobar_m" src="img/photobar/photobar_overlay.png" alt="" />
				</ul>
		...
		<!-- HEADER BLOCK END-->
       	...
       	<header class="page_header">
       		...
       		<div class="wrap">
       			<div class="ninecol">
		       		<h1>Academics</h1>
		       		<p class="breadcrumbs"><a href="#">Home</a> &raquo; <span class="current">Academics</span></p>
       			</div>
       		</div>
       	...
       	<div class="wrap page">
       		...
       		<aside class="threecol side_nav first">
       			<div class="page_links">
       				<ul>
       					...
       					<li><a href="#">Institutes &amp; Centers</a></li>
       					<li><a href="#">Research &amp; Outreach</a></li>
       					<li><a href="#">Internships &amp; Careers</a></li>
       			...
       			<div class="resources">
       				...
       				<ul>
       					<li><a href="#">Mardigian Library</a></li>
       		...
       		<div class="content sixcol">
       			...
       			<div class="intro_copy content_block">
       				<p>This will be a great lead-in paragraph and a sub-heading that make academics "perform". Let's tie into telling our <a href="#">Metropolitan Vision</a> story through our many programs. At vero eos et accusamus et iusto odio dignissimos.</p>
       			</div>
       			...
       			<div class="finder content_block">
       				...
       				<div class="searchbar">
		        		<form>
		        			<input type="text" name="search" id="search_field" placeholder="What do you want to study?" />
		        			<input type="submit" name="submit" id="search_submit" value="Search" />
		        		</form>
		        	</div>
		        	...
		        	<ul class="topic_blocks">
			        	<li><a href="#" class="topic_bg03 topic_block">View All Degree and Certificate Programs</a></li>
			        	<li><a href="#" class="topic_bg04 topic_block">View All Academic Departments</a></li>
		        	</ul>
       			</div>
       			...
       			<div class="topics content_block">
       				<h4>Colleges</h4>
       				<ul class="topic_blocks">
       					<li><a href="#" class="topic_bg01 topic_block"><span>Arts, Sciences, and Letters</span></a></li>
       					<li><a href="#" class="topic_bg02 topic_block"><span>Business</span></a></li>
       					<li><a href="#" class="topic_bg03 topic_block"><span>Education, Health, and Human Services</span></a></li>
       					<li><a href="#" class="topic_bg04 topic_block"><span>Engineering and Computer Science</span></a></li>
       				</ul>
       			</div>
       			
       			<div class="topics content_block">
       				<h4>Teaching, Research, &amp; Community Impact</h4>
       				...
       				<ul class="topic_blocks">
       					<li><a href="#" class="topic_bg_green topic_block"><span>Mardigian Library</span></a></li>
       					<li><a href="#" class="topic_bg_red topic_block"><span>Institutes &amp; Centers</span></a></li>
       					<li><a href="#" class="topic_bg_orange topic_block"><span>Research</span></a></li>
       					<li><a href="#" class="topic_bg_teal topic_block"><span>Faculty</span></a></li>
       				</ul>
       			</div>
       				...
       				<li>
       					<div class="video_widget">
       						<div class="widget_wrap">
			       				<a href="http://www.youtube.com/watch?v=hELiV0FOOn0" class="video_thumbnail fancybox">
			       					<img src="img/youtube_static/academics_01.jpg" alt="" />
			       					<div class="overlay">
			       				...
			       				<table class="play_bar">
			       					<tbody>
			       						<tr>
			       							<td class="play_button"><a href="http://www.youtube.com/watch?v=hELiV0FOOn0" class="fancybox"><img src="img/video_play_button.png" /></a></td>
			       							<td class="video_title"><a href="http://www.youtube.com/watch?v=hELiV0FOOn0" class="fancybox">Difference Makers Commercial - 2011 Update (Drees)</a></td>
			       						</tr>
			       					</tbody>
			       				</table>
       						</div>
       				...
       				<li>
	       				...
	       				<div class="calendar_widget">
	       					<div class="date_block">
	       						<div class="event_cal_icon"><span class="month">Mar</span><span class="day">16</span></div>
	       						<div class="event_title"><a href="#">Last Day to Withdraw from Graduate Classes</a></div>
	       					</div>
	       				</div>
       				</li>
		...
		<!-- PAGE BLOCK END-->	
       	...
       	<div class="carousel news section" style="border-bottom: none;">
       		<div class="wrap">
       			...
       			<ul class="slides clearfix">
       				...
       				<li>
       					...
       					<p>Realistically, this section could be set up to have a really really really long blurb and not break the layout of the site. The height of the container will be flexible, and the text will just keep growing. Definitely should limit the amount of text allowed via cms, though.</p>
       				</li>
       				<li>

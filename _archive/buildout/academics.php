       		...
       		<div class="content sixcol">
       			...
       			<div class="finder content_block">
		        	...
		        	<ul class="topic_blocks">
			        	<li><a href="#" class="">View All Degree and Certificate Programs</a></li>
			        	<li><a href="#" class="">View All Academic Departments</a></li>
		        	</ul>
       			</div>
       			...
       			<div class="topics content_block">
       				<h4>Colleges</h4>
       				<ul class="topic_blocks">
       					<li><a href="#" class="topic_bg01 topic_block">Arts, Sciences, and Letters</a></li>
       					<li><a href="#" class="topic_bg02 topic_block">Business</a></li>
       					<li><a href="#" class="topic_bg03 topic_block">Education, Health, and Human Services</a></li>
       					<li><a href="#" class="topic_bg04 topic_block">Engineering and Computer Science</a></li>
       				</ul>
       			</div>
       			...
       			<div class="topics content_block">
       				...
       				<ul class="topic_blocks">
       					<li><a href="#" class="topic_bg_green topic_block">Mardigian Library</a></li>
       					<li><a href="#" class="topic_bg_red topic_block">Institutes &amp; Centers</a></li>
       					<li><a href="#" class="topic_bg_orange topic_block">Research</a></li>
       					<li><a href="#" class="topic_bg_teal topic_block">Faculty</a></li>
       				</ul>
       			</div>
       		...
       		<div class="wrap">
       			...
       			<ul class="slides clearfix">
       				...
       				<li>
       					...
       					<h3><a href="#">Regents approve designs for Science Building renovations</a></h3>
       					<p>University of Michigan-Dearborn moved one step closer in its pursuit to create a 21st century science experience.</p>
       				</li>
       				<li>
       				...
       				<li>
       					...
       					<h3><a href="#">Amanda Lewan chosen for Cannes Film Fesitival internship program</a></h3>
       					<p>"I remember I used to make up stories in my mind and act out the scenes by myself," she said.</p>
       				</li>
       			</ul>
       		</div>
       	</div>
